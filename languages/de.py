...
'Back': 'Back',
'Build entry for task': 'Build entry for task',
...
'Invalid build number given.': 'Invalid build number given.',
'Invalid email': 'Ungültige Email',
'Invalid entry id given.': 'Invalid entry id given.',
'Invalid Query': 'Ungültige Query',
'invalid request': 'Ungültiger Request',
'Invalid task id given.': 'Invalid task id given.',
'Invalid task number given.': 'Invalid task number given.',
'Is Active': 'Ist aktiv',
'Key': 'Schlüssel',
'Last name': 'Nachname',
'Layout': 'Layout',
...
'No task and entry id given!': 'No task and entry id given!',
...
'Table': 'Tabelle',
'Task': 'Task',
'Task could not be submitted!': 'Task could not be submitted!',
'Task submitted!': 'Task submitted!',
'Task to be uploaded': 'Task to be uploaded',
'Teacher': 'Teacher',
...
'Too much arguments given!': 'Too much arguments given!',
'Traceback': 'Traceback',
'Twitter': 'Twitter',
